...
const TechLogo = () => {
  return (
    <>
       <div className='flex justify-center items-center w-18 h-18 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-[#faf9f9] dark:bg-black dark:border dark:border-white/20 rounded-full p-2 sm:p-3 md:p-4 lg:p-5'>
